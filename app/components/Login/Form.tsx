  ...
  return (
    <form className="w-full md:w-[70%] lg:w-[60%] h-full mx-auto flex flex-col" onSubmit={handleSubmit}>
      ...
      <div className="mt-5 md:mt-16 mx-auto">
        <button onClick={() => setLoading(true)} className="transition-all duration-200 w-[200px] flex justify-evenly items-center bg-white/10 hover:bg-secondary-black rounded-md p-4 text-subtitle-2">
